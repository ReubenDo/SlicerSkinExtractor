...
class SlicerSkinExtractor(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = 'Skin Surface Extractor'
    self.parent.categories = ['Segmentation']
    self.parent.dependencies = []
    self.parent.contributors = ["Reuben Dorent (King's College London)"]  
    self.parent.helpText = (
      'Skin surface extractor based on morphological operations for curve evolution.'
...
def registerSampleData():
  ...
  # SlicerSkinExtractor1
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    # Category and sample name displayed in Sample Data module
    category='SlicerSkinExtractor',
    sampleName='SlicerSkinExtractor1',
    # Thumbnail should have size of approximately 260x280 pixels and stored in Resources/Icons folder.
    # It can be created by Screen Capture module, "Capture all views" option enabled, "Number of images" set to "Single".
    thumbnailFileName=os.path.join(iconsPath, 'SlicerSkinExtractor1.png'),
    # Download URL and target file name
    uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
    fileNames='SlicerSkinExtractor1.nrrd',
    # Checksum to ensure file integrity. Can be computed by this command:
    #  import hashlib; print(hashlib.sha256(open(filename, "rb").read()).hexdigest())
    checksums = 'SHA256:998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95',
    # This node name will be used when the data set is loaded
    nodeNames='SlicerSkinExtractor1'
  )

  # SlicerSkinExtractor2
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    # Category and sample name displayed in Sample Data module
    category='SlicerSkinExtractor',
    sampleName='SlicerSkinExtractor2',
    thumbnailFileName=os.path.join(iconsPath, 'SlicerSkinExtractor2.png'),
    # Download URL and target file name
    uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
    fileNames='SlicerSkinExtractor2.nrrd',
    checksums = 'SHA256:1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97',
    # This node name will be used when the data set is loaded
    nodeNames='SlicerSkinExtractor2'
  )
...
class SlicerSkinExtractorLogic(ScriptedLoadableModuleLogic):
  ...
  def process(self, inputVolume, outputVolume):
    ...
    # Cast image as a SimpleITK 
    volumeIjktoRas = vtk.vtkMatrix4x4()
    inputVolume.GetIJKToRASDirectionMatrix(volumeIjktoRas)
    volumeOrder = inputVolume.ComputeScanOrderFromIJKToRAS(volumeIjktoRas)
    image = su.PullVolumeFromSlicer(inputVolume)
    image = sitk.Cast(image, sitk.sitkFloat32)

    # Create output labelmap
    labelmapVolumeNode = slicer.mrmlScene.AddNewNodeByClass("vtkMRMLLabelMapVolumeNode")
    output = morphological_chan_vese_fillhole_2d_new(image, volumeOrder)
    su.PushVolumeToSlicer(output, targetNode=labelmapVolumeNode)
...
class SlicerSkinExtractorTest(ScriptedLoadableModuleTest):
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_SlicerSkinExtractor1()

  def test_SlicerSkinExtractor1(self):
    ...
    import SampleData
    registerSampleData()
    inputVolume = SampleData.downloadSample('SlicerSkinExtractor1')
